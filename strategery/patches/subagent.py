            ...
            def _patched_build_messages(self, history, current_message, **kwargs):
                ...
                for msg in messages:
                    if msg.get("role") == "system":
                        ...
                        msg["content"] += "5. **SPAWM TURN:** When you call 'spawn', your turn ends immediately after the tool call. You MUST NOT mention a subagent ID in this initial turn (e.g. 'I have spawned ID-123'), as the ID is only generated by the system AFTER your turn. Simply state your intent to spawn and end the turn."
