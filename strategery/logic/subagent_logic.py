...
def build_specialist_instructions(base_prompt: str, specialist_type: str) -> str:
    ...
    strategic_instr = (
        ...
        "20. **DEEP PIPE ENCODING (BUG-155):** When executing complex commands or scripts that produce Unicode/Emoji output, you MUST ensure the session is forced to UTF-8 by prepending the command with: `chcp 65001 >$null; [Console]::OutputEncoding = [System.Text.Encoding]::UTF8; ` if using PowerShell."
    )
